...
#Data was downloaded from https://www.gbif.org/ on Tuesday July 21st 2020 for the genus Phanera 
#DOI: https://doi.org/10.15468/dl.as44t9 

phanera_occurrences<- read.csv('data/GBIF-Phanera-occurrences.csv')